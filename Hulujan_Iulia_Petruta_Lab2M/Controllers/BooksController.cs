...
namespace Hulujan_Iulia_Petruta_Lab2M.Controllers
{
    ...
    {
        private readonly Hulujan_Iulia_Petruta_Lab2MContext _context;

        public BooksController(Hulujan_Iulia_Petruta_Lab2MContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchString)
        {
            ...
            ViewData["AuthorSortParm"]= String.IsNullOrEmpty(sortOrder) ? "lastname_desc" : "";
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
                ...
                s => s.AuthorID, s => s.Title, s => s.Price, s => s.GenreID))
            {
                ...
                {
                    ModelState.AddModelError("", "Unable to save changes. " + "Try again, and if the problem persis");
                }
            }
